...
<body>
<h1>Hola, por favor registra tu mochila:</h1>
<div>
    ...
    <form:form action="/registro/mochila" method="post" modelAttribute="mochila">
    ...
    <button type="submit" class="btn btn-primary">Registrar Mochila</button>
        </form:form>
</div>
